...
resource "aws_iam_policy" "allow_user_manage_self" {
  ...
  policy      = "${ data.aws_iam_policy_document.allow_user_manage_self_policy.json }"
}

data "aws_iam_policy_document" "allow_user_manage_self_policy" {
  statement {
